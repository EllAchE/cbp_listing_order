...
describe('should place limit order', function () {
    it('Should place limit order', function () { return __awaiter(void 0, void 0, void 0, function () {
        var orderResult;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, api_interaction_1.placeLimitOrder(true, "0.000001", "0.000001", "BTC-USD")]; // should place a limit order to buy btc at $0.000001, so should (likely) never execute
                case 1:
                    ...
                    expect(orderResult.filled_size).toBe("10");
                    return [2 /*return*/];
            }
        });
    }); });
...
//# sourceMappingURL=api_call_tests.js.map